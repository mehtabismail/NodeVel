...
module.exports = class AuthService {
    ...
    constructor(app) {
        ...
        if (Config.app('debug')) console.log("* AuthService")

        app.dependOn('crypto')
        app.dependOn('jsonwebtoken')
        app.dependOn('passport')
        app.dependOn('passport-http-bearer')
    ...
    hashPassword(password, salt) {
        ...
        return crypto
            .pbkdf2Sync(
                ...
                Config.app('hash_iterations'),
                Config.app('salt_bytes'),
